...
def restore_community_hierarchy(
    ...
    community_column: str = NODE_COMMUNITY,
    level_column: str = NODE_LEVEL,
    **_kwargs,
) -> pd.DataFrame:
    """Restore the community hierarchy from the node data."""
    node_df: pd.DataFrame = input
    community_df = (
                    ...
                    community_hierarchy.append(
                        {
                            ...
                            COMMUNITY_LEVEL: level,
                            SUB_COMMUNITY: next_level_community,
                            SUB_COMMUNITY_SIZE: len(next_entities),
                        }
                    )
