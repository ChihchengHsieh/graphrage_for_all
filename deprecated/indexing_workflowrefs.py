...
class PipelineWorkflowReference:
    pass
...
PipelineWorkflowReference(
    ...
    steps=None,
    config={"document_attribute_columns": []},
)
...
PipelineWorkflowReference(
    name="join_text_units_to_relationship_ids", steps=None, config=None
)
PipelineWorkflowReference(
...
PipelineWorkflowReference(
    ...
    config={
        ...
        "cluster_graph": {"strategy": {"type": "leiden", "max_cluster_size": 10}},
        "embed_graph": {
            "strategy": {
                "type": "node2vec",
                "num_walks": 10,
...
PipelineWorkflowReference(
    ...
    steps=None,
    config={"layout_graph_enabled": False, "snapshot_top_level_nodes": False},
)
