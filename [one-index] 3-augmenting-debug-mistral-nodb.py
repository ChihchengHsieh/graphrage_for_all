...
send_fn = get_send_fn(
    source="huggingface",
    model_name="mistralai/Mistral-7B-Instruct-v0.2",  # ["meta-llama/Meta-Llama-3.1-8B-Instruct", "microsoft/Phi-3.5-mini-instruct", "google/gemma-2-2b-it", "meta-llama/Llama-3.2-1B-Instruct", "meta-llama/Llama-3.2-3B-Instruct"]
)
DEFAULT_LLM_ARGS = {
    "temperature": 0.0,
    "top_p": 1.0,
...
if __name__ == "__main__":
    ...
    for idx, row in tqdm(sample_df.iterrows()):
        ...
        augmented_df.to_csv(f"augmented-mistral-nodb.csv")
